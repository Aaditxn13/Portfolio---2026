 ...
 * https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@7d19309e5e2c3d0a758f521469978570435023d6/asset/dappled-tree.png. Mounts on #hero-dappled-canvas inside
...
(function () {
    ...
    loader.load(
        'https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@7d19309e5e2c3d0a758f521469978570435023d6/asset/dappled-tree.png',
        (tex) => {
        ...
        undefined,
        (err) => {
            console.warn('[dappled-light] failed to load https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@7d19309e5e2c3d0a758f521469978570435023d6/asset/dappled-tree.png', err);
        }
    );

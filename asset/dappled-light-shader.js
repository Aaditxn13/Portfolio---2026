 ...
 * https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@d2f6b942877dab0806fa2bd743ef0e69a5c721ef/asset/dappled-tree.png. Mounts on #hero-dappled-canvas inside
...
(function () {
    ...
    loader.load(
        'https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@d2f6b942877dab0806fa2bd743ef0e69a5c721ef/asset/dappled-tree.png',
        (tex) => {
        ...
        undefined,
        (err) => {
            console.warn('[dappled-light] failed to load https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@d2f6b942877dab0806fa2bd743ef0e69a5c721ef/asset/dappled-tree.png', err);
        }
    );

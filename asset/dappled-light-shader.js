 ...
 * https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@36e1883bba1d8a871b3588f923e69ca21a63d0af/asset/dappled-tree.png. Mounts on #hero-dappled-canvas inside
...
(function () {
    ...
    loader.load(
        'https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@36e1883bba1d8a871b3588f923e69ca21a63d0af/asset/dappled-tree.png',
        (tex) => {
        ...
        undefined,
        (err) => {
            console.warn('[dappled-light] failed to load https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@36e1883bba1d8a871b3588f923e69ca21a63d0af/asset/dappled-tree.png', err);
        }
    );

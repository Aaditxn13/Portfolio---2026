 ...
 * https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@d715f3f9852da559aef04d5c1921abbf633d8751/asset/dappled-tree.png. Mounts on #hero-dappled-canvas inside
...
(function () {
    ...
    loader.load(
        'https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@d715f3f9852da559aef04d5c1921abbf633d8751/asset/dappled-tree.png',
        (tex) => {
        ...
        undefined,
        (err) => {
            console.warn('[dappled-light] failed to load https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@d715f3f9852da559aef04d5c1921abbf633d8751/asset/dappled-tree.png', err);
        }
    );

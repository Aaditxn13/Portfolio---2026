 ...
 * https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@0b86888f6627f2e888a8f8293336059187932063/asset/dappled-tree.png. Mounts on #hero-dappled-canvas inside
...
(function () {
    ...
    loader.load(
        'https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@0b86888f6627f2e888a8f8293336059187932063/asset/dappled-tree.png',
        (tex) => {
        ...
        undefined,
        (err) => {
            console.warn('[dappled-light] failed to load https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@0b86888f6627f2e888a8f8293336059187932063/asset/dappled-tree.png', err);
        }
    );

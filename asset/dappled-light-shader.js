 ...
 * https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@d109536619d7c134e13664c1306b4df11e9b805b/asset/dappled-tree.png. Mounts on #hero-dappled-canvas inside
...
(function () {
    ...
    loader.load(
        'https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@d109536619d7c134e13664c1306b4df11e9b805b/asset/dappled-tree.png',
        (tex) => {
        ...
        undefined,
        (err) => {
            console.warn('[dappled-light] failed to load https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@d109536619d7c134e13664c1306b4df11e9b805b/asset/dappled-tree.png', err);
        }
    );

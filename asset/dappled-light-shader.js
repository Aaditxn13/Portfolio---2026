 ...
 * https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@98c6bdf2f069da5c190ca82a4cc124b8d4cb6da4/asset/dappled-tree.png. Mounts on #hero-dappled-canvas inside
...
(function () {
    ...
    loader.load(
        'https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@98c6bdf2f069da5c190ca82a4cc124b8d4cb6da4/asset/dappled-tree.png',
        (tex) => {
        ...
        undefined,
        (err) => {
            console.warn('[dappled-light] failed to load https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@98c6bdf2f069da5c190ca82a4cc124b8d4cb6da4/asset/dappled-tree.png', err);
        }
    );

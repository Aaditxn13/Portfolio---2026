...
function scheduleSitePrefetch() {
    ...
    const loadPrefetch = () => {
        ...
        const script = document.createElement('script');
        script.src = 'asset/site-prefetch.js?v=cdn-debug-2';
        script.defer = true;
...
if (headerMount) {
    ...
    const resumePreviewUrl = 'https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@8ca13287979be8bddbc5e16ceef6f0e7dae8d92f/asset/Aditya_Sadhukhan_Resume-preview.png';
    const resumeDownloadName = 'Aditya_Sadhukhan_Resume.pdf';
    const logoSrc = typeof window.resolveAssetUrl === 'function'
        ? window.resolveAssetUrl('https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@8ca13287979be8bddbc5e16ceef6f0e7dae8d92f/asset/Logo.svg')
        : 'https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@8ca13287979be8bddbc5e16ceef6f0e7dae8d92f/asset/Logo.svg';
    ...
    headerMount.innerHTML = `
        ...
        <div class="resume-modal" id="resume-modal" aria-hidden="true">
            ...
            <section class="resume-modal__panel" role="dialog" aria-modal="true" aria-label="Resume preview">
                <div class="resume-modal__actions">
                    <a href="${resumeUrl}" class="resume-modal__icon-btn" download="${resumeDownloadName}" aria-label="Download resume PDF">
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" aria-hidden="true">
                            <path d="M9 2.5V11M9 11L5.75 7.75M9 11L12.25 7.75M4 14.5H14" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </a>
                    <button type="button" class="resume-modal__icon-btn resume-modal__close" data-resume-close aria-label="Close resume preview">
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" aria-hidden="true">
                            <path d="M4.5 4.5L13.5 13.5M13.5 4.5L4.5 13.5" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
                        </svg>
                    </button>
                ...
                <div class="resume-modal__preview">
                    <img class="resume-modal__image" src="${resumePreviewUrl}" alt="Aditya Sadhukhan resume preview">
                </div>
            </section>
        </div>
    `;
            ...
            <div class="container">
                <section class="footer-cta-shell" aria-labelledby="footer-heading">
                    <div class="footer-sticker-stack" aria-hidden="true">
                        ...
                        <img data-src="https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@8ca13287979be8bddbc5e16ceef6f0e7dae8d92f/asset/sticky-note.png" alt="Sticky Note" class="sticker-image" width="307" height="307" decoding="async" fetchpriority="low">
                    </div>
                ...
                <div class="footer-meta">
                    <div class="footer-meta-socials">
                        <a href="https://www.linkedin.com/in/adityasad/" class="footer-meta-social" aria-label="LinkedIn (opens in a new tab)" target="_blank" rel="noopener noreferrer">
                            <img src="https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@8ca13287979be8bddbc5e16ceef6f0e7dae8d92f/asset/social-linkedin.svg" alt="" width="32" height="32">
                        </a>
                        <a href="https://www.instagram.com/aaadit.yaa/" class="footer-meta-social" aria-label="Instagram (opens in a new tab)" target="_blank" rel="noopener noreferrer">
                            <img src="https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@8ca13287979be8bddbc5e16ceef6f0e7dae8d92f/asset/social-instagram.svg" alt="" width="32" height="32">
                        </a>
                        <a href="https://x.com/aaadit_s" class="footer-meta-social" aria-label="X (opens in a new tab)" target="_blank" rel="noopener noreferrer">
                            <img src="https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@8ca13287979be8bddbc5e16ceef6f0e7dae8d92f/asset/social-x.svg" alt="" width="32" height="32">
                        </a>
                    </div>
                </div>
                ...
                <figure class="footer-grass-scene" aria-hidden="true" data-footer-grass-scene>
                    <img
                        ...
                        data-src="https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@8ca13287979be8bddbc5e16ceef6f0e7dae8d92f/asset/grass-footer.jpg"
                        alt=""
                        width="1440"
                        height="400"
                        decoding="async"
                    ...
                    <img
                        ...
                        data-src="https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@8ca13287979be8bddbc5e16ceef6f0e7dae8d92f/asset/grass-footer-dark.png"
                        alt=""
                        width="1440"
                        height="400"
                        decoding="async"
...
const HOME_CARD_BACKGROUND_PATHS = new Set([
    'https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@8ca13287979be8bddbc5e16ceef6f0e7dae8d92f/asset/home-project-cards/grassland.jpg',
    'https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@8ca13287979be8bddbc5e16ceef6f0e7dae8d92f/asset/home-project-cards/water.webp',
    'https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@8ca13287979be8bddbc5e16ceef6f0e7dae8d92f/asset/home-project-cards/project-3-night-meadow-background.jpg',
    'https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@8ca13287979be8bddbc5e16ceef6f0e7dae8d92f/asset/home-project-cards/project-4-green-background.jpg'
]);
const HOME_CARD_SHADER_BACKGROUNDS = {
    'card-1': 'https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@8ca13287979be8bddbc5e16ceef6f0e7dae8d92f/asset/home-project-cards/grassland.jpg',
    'card-2': 'https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@8ca13287979be8bddbc5e16ceef6f0e7dae8d92f/asset/home-project-cards/water.webp',
    'card-3': 'https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@8ca13287979be8bddbc5e16ceef6f0e7dae8d92f/asset/home-project-cards/project-3-night-meadow-background.jpg',
    'card-4': 'https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@8ca13287979be8bddbc5e16ceef6f0e7dae8d92f/asset/home-project-cards/project-4-green-background.jpg'
};
    ...
    try {
        ...
        Object.values(parsed.cards).forEach((card) => {
            if (card && typeof card === 'object') {
                if (card.src) card.src = withAssetBaseUrl(card.src);
                if (card.backgroundSrc) card.backgroundSrc = withAssetBaseUrl(card.backgroundSrc);
            }
        });
        return parsed;
    } catch (error) {
...
function initBeyondPixelsGallery() {
    ...
    const images = [
        "https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@8ca13287979be8bddbc5e16ceef6f0e7dae8d92f/asset/gallery-beyond-pixels/gallery-web-01.jpg",
        "https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@8ca13287979be8bddbc5e16ceef6f0e7dae8d92f/asset/gallery-beyond-pixels/gallery-web-02.jpg",
        "https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@8ca13287979be8bddbc5e16ceef6f0e7dae8d92f/asset/gallery-beyond-pixels/gallery-web-03.jpg",
        "https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@8ca13287979be8bddbc5e16ceef6f0e7dae8d92f/asset/gallery-beyond-pixels/gallery-web-04.jpg",
        "https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@8ca13287979be8bddbc5e16ceef6f0e7dae8d92f/asset/gallery-beyond-pixels/gallery-web-05.jpg",
        "https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@8ca13287979be8bddbc5e16ceef6f0e7dae8d92f/asset/gallery-beyond-pixels/gallery-web-06.jpg",
        "https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@8ca13287979be8bddbc5e16ceef6f0e7dae8d92f/asset/gallery-beyond-pixels/gallery-web-07.jpg"
    ];
...
(function initPlayCanvas() {
    ...
    function populateDetail(card) {
        ...
        const stats = [
            { value: card.dataset.playHeart, icon: 'https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@8ca13287979be8bddbc5e16ceef6f0e7dae8d92f/asset/play-tab-assets/play_gradinettexture_heart.png', label: 'Likes' },
            { value: card.dataset.playUser, icon: 'https://cdn.jsdelivr.net/gh/Aaditxn13/Portfolio---2026@8ca13287979be8bddbc5e16ceef6f0e7dae8d92f/asset/play-tab-assets/play_gradinettexture_user.png', label: 'Users reached' }
